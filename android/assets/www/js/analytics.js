...
Analytics.prototype.start = function(successCallback, failureCallback) {
    return cordovaRef.exec(successCallback, failureCallback, 'GoogleAnalyticsTracker', 'start', []);
};
...
Analytics.prototype.stop = function(successCallback, failureCallback) {
    return cordovaRef.exec(successCallback, failureCallback, 'GoogleAnalyticsTracker', 'stop', []);
};
...
Analytics.prototype.trackPageView = function(key, successCallback, failureCallback) {
    return cordovaRef.exec(successCallback, failureCallback, 'GoogleAnalyticsTracker', 'trackPageView', [key]);
};
...
Analytics.prototype.trackEvent = function(category, action, label, value, successCallback, failureCallback) {
    return cordovaRef.exec(successCallback, failureCallback, 'GoogleAnalyticsTracker', 'trackEvent', [category, action, typeof label === "undefined" ? "" : label, (isNaN(parseInt(value, 10))) ? 0 : parseInt(value, 10)]);
};
...
Analytics.prototype.trackTiming = function(category, timing, name, label, successCallback, failureCallback) {
    return cordovaRef.exec(successCallback, failureCallback, 'GoogleAnalyticsTracker', 'trackTiming', [category, timing, name, typeof label === "undefined" ? "" : label]);
};
...
Analytics.prototype.setCustomDimension = function(index, value, successCallback, failureCallback) {
    return cordovaRef.exec(successCallback, failureCallback, 'GoogleAnalyticsTracker', 'setCustomDimension', [parseInt(index, 10) || 0, typeof value === "undefined" ? "" : value]);
};
...
Analytics.prototype.trackSocial = function(network, action, target, successCallback, failureCallback) {
    return cordovaRef.exec(successCallback, failureCallback, 'GoogleAnalyticsTracker', 'trackSocial', [network, action, typeof target === "undefined" ? "" : target]);
};
...
Analytics.prototype.trackCommerce = function(transactionId,orderTotal,affiliation,currencyCode,SKU,productName,productPrice,productQuantity,productCategory, successCallback, failureCallback) {
    return cordovaRef.exec(successCallback, failureCallback, 'GoogleAnalyticsTracker', 'trackCommerce', 
